                ...
                return function $tooltip(type, prefix, defaultTriggerShow) {
                    ...
                    var template =
                        '<div ' + directiveName + '-popup ' +
                            ...
                            'border-color="' + startSym + 'tt_borderColor' + endSym + '" ' +
...
//                                });
                                ...
                                attrs.$observe(prefix + 'BorderColor', function (val) {
                                    scope.tt_borderColor = val;
                                });
        ...
        .directive('ticketPopoverPopup', function (dictionaries, timeConverter) {
            ...
            return {
                restrict: 'EA',
                replace: true,
                scope: { borderColor: '@', content: '=', placement: '@', animation: '&', isOpen: '&' },
                link: function (scope) {
        ...
        .directive('ticketPopover', function ($extTooltip) {
            return $extTooltip('ticketPopover', 'popover', 'mouseenter');
        });
})();